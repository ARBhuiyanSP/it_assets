                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">SPL@Clients</h4>
            ...
            <div class="col-md-3">
                <form id="sidebar">
                    <div class="form-group">
                        <label for="id">Ckient ID</label>
                        <input type="text" id="id" name="id" class="form-control" placeholder="Identity" value="C-"/>
                    </div>
                    <div class="form-group">
