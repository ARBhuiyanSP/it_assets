                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Rented Assets List</h4>
									...
									<table id="datatable" class="table table-striped table-bordered">
										...
										<tbody>
											...
											?>
												...
												$sql2 = "SELECT sum(quantity) FROM  `gate_pass` where `challan_no`='$challan_no'";
										...
										?>
												...
												<button onclick="window.location.href = 'returnview.php?id=<?php echo $row['challan_no'] ?>'" class=''>Details <i class="fa fa-eye text-success"></i></button>
												</td>
											</tr>
