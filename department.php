                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">SPL@Department</h4>
            ...
            <div class="col-md-3">
                <form id="sidebar">
                    <div class="form-group">
                        ...
                        <input type="text" id="id" name="id" class="form-control" placeholder="Identity" value="dept-"/>
                    </div>
                    <div class="form-group">
                        <label for="nm">Department Name</label>
                        <input type="text" id="nm" name="nm" class="form-control" placeholder="Department Name"/>
                    </div>
...
<script type="text/javascript">
		...
		<script src="script_dept.js"></script>
